...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Admin Olahraga</h1>
            ...
            <a href="tambah-olahraga.php" class="btn btn-primary">Tambah berita olahraga</a><br /><br />
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM olahraga ORDER BY id DESC"; 
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    while ($row = mysqli_fetch_assoc($query_run)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../images/olahraga/<?php echo htmlspecialchars($row['foto']); ?>" width="100" height="100" alt="Gambar">
                                            </td>
                                            <td>
    <?php
    ...
    ?>
                                            ...
                                            <td>
                                                <a href="edit-olahraga.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">EDIT</a>
                                            </td>
                                            <td>
                                                <a href="hapus-olahraga.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus?');">HAPUS</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
