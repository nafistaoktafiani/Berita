...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            <h1 class="mt-4">Admin fashion</h1>
            ...
            <a href="tambah-olahraga.php" class="btn btn-primary">Tambah berita fashion</a><br /><br />
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <table id="datatablesSimple">
                        ...
                        <tbody>
                            ...
                            $query = "SELECT * FROM fashion ORDER BY id DESC"; 
                                ...
                                if (mysqli_num_rows($query_run) > 0) {
                                    while ($row = mysqli_fetch_assoc($query_run)) {
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <img src="../images/fashion/<?php echo htmlspecialchars($row['foto']); ?>" width="100" height="100" alt="Gambar">
                                            </td>
                                            <td>
    <?php
    ...
    ?>
                                            ...
                                            <td>
                                                <a href="edit-fashion.php?id=<?php echo $row['id']; ?>" class="btn btn-warning">EDIT</a>
                                            </td>
                                            <td>
                                                <a href="hapus-fashion.php?id=<?php echo $row['id']; ?>" class="btn btn-danger" onclick="return confirm('Yakin ingin menghapus?');">HAPUS</a>
                                            </td>
                                        </tr>
                                        <?php
                                    }
