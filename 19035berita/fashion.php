...
<div class="row">
    ...
    $query = "SELECT * FROM fashion ORDER BY id DESC"; // Sesuaikan nama tabel dan kolom
            ...
            <div class="col-md-6 col-lg-3">
                <div class="guide-item">
                    <div class="guide-img">
                        ...
                        <img src="http://localhost/news-website-templates/images/fashion/<?php echo htmlspecialchars($foto); ?>" class="img-fluid w-100 rounded-top" alt="Image">
                        </div>
                    </div>
